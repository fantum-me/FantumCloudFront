        ...
        button: {
            ...
            color: {
                primary: {
                    ...
                    soft: "text-primary-500 dark:text-primary-400 bg-primary-50 dark:bg-primary-500/10 hover:bg-primary-100 dark:hover:bg-primary-600/20 dark:border dark:border-primary-700"
                },
                gray: {
